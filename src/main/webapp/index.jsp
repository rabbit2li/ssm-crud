	...
	<script type="text/javascript">
		...
		function build_emps_table(result){
			...
			$.each(emps,function(index,item){
				...
				*/
				...
				editBtn.attr("edit_btn",item.empId);
		...
		function validate_add_form(){
			...
			if(!regName.test(empName)){
				...
				$("#empName_add_input").next("span").text("用户名可以是2-5位中文或6-16位英文和数字的组合"); */
				return false;
			}else{
		...
		$(document).on("click",".edit_btn",function(){
			//弹出模态框
			//1 查出并显示员工信息
			getEmp($(this).attr("edit_btn"));
			
			//弹出模态框时将id加到更新按钮上
			$("#emp_update_btn").attr("edit_id",$(this).attr("edit_btn"));
